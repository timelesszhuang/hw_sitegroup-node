...
<div class="shenqing">
            ...
            <div>
                <label>职位：</label>
                <input type="text"name="name" id="userNameSales"placeholder="请输入职位">
            ...
            <div>
                <label>其他需求：</label>
                <input type="text" name="email" id="email"placeholder="请输入其他需求" class="xuqiu">
    ...
    <script>
        $(function () {
            $('#submit_bottom').click(function () {
                ...
                var url = 'http://local.salesman.cc/index.php/Shuaidan_ceshi/PublicTry/index';
